...
function ProductsEdit() {
    ...
    const handleSubmit = (e) => {
        ...
        let totalExistingCount = existingImages.length;
        ...
        // Características - enviar todas (incluyendo vacías para saber qué eliminar)
        let charIndex = 0;
        for (let typeId in selectedCharacteristics) {
            const val = selectedCharacteristics[typeId];
            // Enviar siempre, incluso si está vacío (para saber que se debe eliminar)
