...
function UsersCreate() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`http://localhost:8000/api/users/${id}`, {
      ...
      .then(data => {
        console.log('Usuari edita:', data);
        navigate("/admin/users");
      })
      .catch(err => {
        console.error('Error detallat:', err);
        alert('Error al editar l usuari. Revisa la consola per mes detalls.');
      });
  };

  return (
    <div className="dashboard-content">
      <h1 className="dashboard-title">Edita usuari</h1>
      <h3 className="dashboard-subtitle">Editar el usuari</h3>
