...
function productDisplaySearch({ products, characteristics, title }) {
    ...
    return (
        <section className='categoryProductDisplay'>
            ...
            {/* Section header — same as FeaturedProducts */}
                            ...
                            <div className="rangeFilter">
                                <input 
                                    ...
                                    onChange={(e) => { 
                                        ...
                                        searchProductsInStore(savedText, savedFilters, dinamicFilters, e.target.value, maxPrice, minWeight, maxWeight);
                                    }}
                                />€
                                ...
                                <input 
                                    ...
                                    onChange={(e) => { 
                                        ...
                                        searchProductsInStore(savedText, savedFilters, dinamicFilters, minPrice, e.target.value, minWeight, maxWeight);
                                    }}
                                />€
                            </div>
                        </div>
                                ...
                                <div className="info">
                                    ...
                                    <div className="bottom">
                                        <div className="priceGroup">
                                            ...
                                            {product.discount > 0 && (
                                                <span className="oldPrice">{product.base_price}€</span>
                                            )}
                                        </div>
